...
public class NutriProfiler {
	...
	/**
	 * Enum class for physical activity
	 * **/
	...
	/**
	 * this method will create nutrition profile for a specific person
	 * **/
	static void createNutriProfile(Person person) {
		...
		float[] nutriList = person.calculateNutriRequirement();
		for (NutriEnum e : NutriEnum.values()){
			person.recommendedNutrientsList.add(new RecommendedNutrient(e.getNutrientCode(),nutriList[e.nutriIndex]));
		}
